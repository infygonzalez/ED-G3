...
public class NuevoEvento extends JFrame {
	...
	public NuevoEvento(Agencia agencia) {
		...
		cbElegirViaje_2_1.setModel(new DefaultComboBoxModel(new String[] {"", "Novios", "Senior", "Grupos", "Grandes viajes(destinos exoticos)", "Combinado(vuelo+hotel)", "Escapadas", "Familias con niños menores"}));
		cbElegirViaje_2_1.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		cbElegirViaje_2_1.setBounds(635, 54, 250, 41);
		//contentPane.add(cbElegirViaje_2_1);
	...
	public JPanel desplegarAlojamiento() {
		...
		contentPane.add(panelAlojamiento);
				...
				cbTipoHabitacion.setModel(new DefaultComboBoxModel(new String[] {"", "Doble ", "Doble con uso individual", "Individual", "Triple"}));
	...
	public void cambiarPaneles(String TipoViaje) {
		...
		if(TipoViaje == "Vuelo") {
			...
			panelVuelo = desplegarVuelo();

		}
		if(TipoViaje =="Alojamiento") {
			panelVuelo.setVisible(false);
			panelOtros.setVisible(false);
			panelAlojamiento = desplegarAlojamiento();
		}
		if(TipoViaje =="Otros") {
			panelVuelo.setVisible(false);
			panelAlojamiento.setVisible(false);
			panelOtros = desplegarOtros();
		}
	}
}
